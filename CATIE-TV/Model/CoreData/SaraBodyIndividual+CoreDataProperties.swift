//
//  SaraBodyIndividual+CoreDataProperties.swift
//  CATIE-TV
//
...
public extension SaraBodyIndividual {
    @nonobjc class func fetchRequest() -> NSFetchRequest<SaraBodyIndividual> {
        NSFetchRequest<SaraBodyIndividual>(entityName: "SaraBodyIndividual")
    }
