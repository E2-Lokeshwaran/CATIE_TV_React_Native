//
//  SaraBodyText+CoreDataProperties.swift
//  CATIE-TV
//
...
public extension SaraBodyText {
    @nonobjc class func fetchRequest() -> NSFetchRequest<SaraBodyText> {
        NSFetchRequest<SaraBodyText>(entityName: "SaraBodyText")
    }

    @NSManaged var pointers: String?
