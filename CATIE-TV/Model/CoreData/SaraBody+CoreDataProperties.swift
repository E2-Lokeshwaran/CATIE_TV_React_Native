//
//  SaraBody+CoreDataProperties.swift
//  CATIE-TV
//
...
public extension SaraBody {
    @nonobjc class func fetchRequest() -> NSFetchRequest<SaraBody> {
        NSFetchRequest<SaraBody>(entityName: "SaraBody")
    }
