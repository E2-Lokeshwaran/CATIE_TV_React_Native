//
//  SaraHeader+CoreDataProperties.swift
//  CATIE-TV
//
...
public extension SaraHeader {
    @nonobjc class func fetchRequest() -> NSFetchRequest<SaraHeader> {
        NSFetchRequest<SaraHeader>(entityName: "SaraHeader")
    }

    @NSManaged var headerText: String?
